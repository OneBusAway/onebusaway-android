...
@Config(constants = BuildConfig.class, application = org.onebusaway.android.app.Application.class)
public class ObaTestCase {
    ...
    public void before() {
        ...
        RuntimeEnvironment.application.setTheme(R.style.Theme_OneBusAway);

        mMock = new ObaMock(RuntimeEnvironment.application);
