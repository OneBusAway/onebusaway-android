...
data class TripReportContext(
    ...
    /** Predicted arrival/departure epoch millis, or null when there is no prediction (never coerce to 0). */
        ...
        fun decode(encoded: String?): ReportContext {
            ...
            val trip = tripId?.let {
                TripReportContext(
                    ...
                    predictedArrivalTime = predictedArrivalTime?.toLong(),
                    predictedDepartureTime = predictedDepartureTime?.toLong(),
