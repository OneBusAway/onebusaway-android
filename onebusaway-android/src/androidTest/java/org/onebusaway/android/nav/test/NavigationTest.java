...
public class NavigationTest extends ObaTestCase {
  ...
  /**
   * Started Stop: Mckinley Dr @ DOT Bldg Destination Stop: University Area Transit Center Recorded
   * In: Bus (Route 5) 9 stops Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Mckinley Dr @ DOT Bldg Destination Stop: University Area Transit Center Recorded
   * In: car following Bus (Route 5) 9 stops Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Alumni Dr @ Leroy Collins @ Eng Bldg Destination Stop: Mckinley Dr @ Fowler Ave
   * Recorded In: Bus Route 5 - 1 stops Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Alumni Dr @ Leroy Collins @ Eng Bldg Destination Stop: Mckinley Dr @ Fowler Ave
   * Recorded In: Car following Route 5 - 1 stops Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Dale Mabry Hwy @ Linebaugh Av Destination Stop: Dale Mabry Hwy @ Hudson Ln @ Taco
   * Bell Recorded In: Bus (Route 36) 4 stops Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Dale Mabry Hwy @ Linebaugh Av Destination Stop: Dale Mabry Hwy @ Hudson Ln @ Taco
   * Bell Recorded In: car following Bus (Route 36) 4 stops Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Gunn Hwy @ Mullis City Way Destination Stop: Gunn Hwy @ Anderson Rd Recorded In:
   * Bus (Route 39) Number of Stops = 7 Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Gunn Hwy @ Mullis City Way Destination Stop: Gunn Hwy @ Anderson Rd Recorded In:
   * car following Bus (Route 39) Number of Stops = 7 Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Linebaugh @ Henderson Av Destination Stop: Anderson Rd @ 8110 Recorded In: Bus
   * (Route 7) 4 stops Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Linebaugh @ Henderson Av Destination Stop: Anderson Rd @ 8110 Recorded In: Car
   * following Bus (Route 7) 4 stops Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Himes Av @ Colwell Av Destination Stop: Himes Av @ Hillsborough Av Recorded In:
   * Bus (Route 36) 12 stops Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Himes Av @ Colwell Av Destination Stop: Himes Av @ Hillsborough Av Recorded In:
   * car following Bus (Route 36) 12 stops Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Gunn Hwy @ Premier North Dr Destination Stop: Bush Blvd @ Armenia Av Recorded In:
   * Bus (Route 39) 3 stops Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Gunn Hwy @ Premier North Dr Destination Stop: Bush Blvd @ Armenia Av Recorded In:
   * Car following Bus (Route 39) 3 stops Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Alumni Dr @ Beard Destination Stop: Magnolia Dr @ Alumni Dr Recorded In: Route 5
   * (1 stop) Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Alumni Dr @ Beard Destination Stop: Magnolia Dr @ Alumni Dr Recorded In: Car
   * following Route 5 (1 stop) Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: 40 St @ E Hamilton Destination Stop: Mckinley Dr @ Bougainvillea Av Recorded In:
   * Bus Route 5 (10 stops) Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: 40 St @ E Hamilton Destination Stop: Mckinley Dr @ Bougainvillea Av Recorded In:
   * car following Route 5 (10 stops) Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Mckinley Dr @ Bougainvillea Av Destination Stop: 40 St @ Miller Ave Recorded In:
   * Bus Route 5 (6 stops) Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Mckinley Dr @ Bougainvillea Av Destination Stop: 40 St @ Miller Ave Recorded In:
   * car following the bus Route 5 (6 stops) Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: 22nd St @ Okara Rd Destination Stop: 22nd St @ 111th Av Recorded In: Bus route 12
   * (4 stops) Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: 22nd St @ Okara Rd Destination Stop: 22nd St @ 111th Av Recorded In: Car
   * following bus route 12 (4 stops) Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Bruce B Downs Bl @ Lakeside Commons Destination Stop: Fletcher Av @Usf Banyan Cir
   * Recorded In: Bus route 18 (2 stops) Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Bruce B Downs Bl @ Lakeside Commons Destination Stop: Fletcher Av @Usf Banyan Cir
   * Recorded In: Car following bus route 18 (2 stops) Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Busch Blvd @ 40thSt Destination Stop: Busch Blvd @ 50th St Recorded In: Bus route
   * 39 (5 stops) Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Busch Blvd @ 40thSt Destination Stop: Busch Blvd @ 50th St Recorded In: Bus route
   * 39 (5 stops) Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Busch Blvd @ 52nd St Destination Stop: Busch Blvd @ 22nd St Recorded In: Bus
   * route 39 (12 stops) Device Used: Kyocera FIXME - This test is failing because the lat/long for
   * the 2nd-to-last stop is wrong - it's not where the actual physical stop is located. Hence, it
   * appears that the pull the cord alert is triggered to soon.
   */
  @Test
  ...
  /**
   * Started Stop: Busch Blvd @ 52nd St Destination Stop: Busch Blvd @ 22nd St Recorded In: Car
   * following bus route 39 (12 stops) Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Busch Blvd @ 12 St Destination Stop: Busch Blvd @ 33 Rd St Recorded In: Bus route
   * 39 7 stops Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Busch Blvd @ 12 St Destination Stop: Busch Blvd @ 33 Rd St Recorded In: Car
   * following bus route 39 Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Library LIB Destination Stop: Magnolia apartments Recorded In: Bull Runner route
   * D Device Used: Kyocera FIXME - this test is failing with "Get ready triggered too soon"
   */
  @Test
  ...
  /**
   * Started Stop: Library LIB Destination Stop: Magnolia apartments Recorded In: Car following Bull
   * Runner route D Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Marshall Student Center Destination Stop: Holly at Magnolia Dr Recorded In: Bull
   * Runner route D Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Stop 504 Destination Stop: Library LIB Recorded In: Bull Runner route F Device
   * Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Stop 504 Destination Stop: Library LIB Recorded In: car following Bull Runner
   * route F Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Social Science Destination Stop: Library LIB Recorded In: Car following Bull
   * Runner route C Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Math and Engineering Destination Stop: Epsilon Hall Recorded In: Bull Runner
   * route C Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Math and Engineering Destination Stop: Epsilon Hall Recorded In: Car following
   * Bull Runner route C Device Used: Kyocera
   */
  @Test
  ...
  /**
   * Started Stop: Marshall Student Center Destination Stop: Center of Transportation Research
   * Recorded In: Bull Runner route E Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Marshall Student Center Destination Stop: Holly Mail Room Recorded In: Bull
   * Runner route E Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Marshall Student Center Destination Stop: Holly Mail Room Recorded In: Car
   * following Bull Runner route E Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: USF library LIB Destination Stop: Patel Center Recorded In: Bull Runner route A
   * Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: USF library LIB Destination Stop: Patel Center Recorded In: Car following the
   * Bull Runner route A Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Baseball Field Destination Stop: Greek Housing Recorded In: Bull Runner route A
   * Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Baseball Field Destination Stop: Greek Housing Recorded In: Car following Bull
   * Runner route A Device Used: Nexus 5
   */
  @Test
  ...
  /**
   * Started Stop: Fletcher Avenue @ 46th Street Destination Stop: University Area Transit Center
   * Recorded In: Route 6 Device Used: ZTE Z831
   */
  @Test
  ...
  /**
   * Started Stop: University Area Transit Center Destination Stop: Fletcher Avenue @ Palm Drive
   * MetroRapid Recorded In: Route 6 Device Used: ZTE Z831
   */
  @Test
  ...
  /**
   * Started Stop: Fletcher Avenue @ Palm Drive MetroRapid Destination Stop: 56th Street @ 131st
   * Avenue (S) Recorded In: Route 6 Device Used: ZTE Z831
   */
  @Test
  ...
  /**
   * Started Stop: 56th Street @ 131st Avenue (N) Destination Stop: Fletcher Avenue @ 42nd Street
   * MetroRapid Recorded In: Route 6 Device Used: ZTE Z831
   */
  @Test
  ...
  /**
   * Started Stop: Fletcher Avenue @ 42nd Street MetroRapid Destination Stop: University Area
   * Transit Center Recorded In: Route 6 Device Used: One Plus 6
   */
  @Test
  ...
  /**
   * Started Stop: University Area Transit Center Destination Stop: 15th St @ 127 avenue Recorded
   * In: Route 42 Device Used: One Plus 6
   */
  @Test
  ...
  /**
   * Started Stop: 15th St @127 avenue Destination Stop: Bruce B Downs Bl @ Lakeside Commons
   * Recorded In: Route 42 Device Used: ZTE Z831
   */
  @Test
  ...
  /**
   * Started Stop: Bruce B Downs Bl @ Lakeside Commons Destination Stop: University Area Transit
   * Center Recorded In: Route 42 Device Used: ZTE Z831
   */
  @Test
  ...
  /**
   * Started Stop: MTS_18222357 Destination Stop: MTS_40372 Recorded In: MTS Route 34 Device Used:
   * Pixel 8 Pro
   */
  @Test
  ...
  public void testDistanceUnitConversion() {
    ...
    assertEquals(
        "Meters to miles conversion should be accurate", expectedMiles, actualMiles, 0.00001);
    ...
    String feetString =
        context
            .getResources()
            .getQuantityString(R.plurals.distance_feet, feetImperial, feetImperial);
    assertTrue(
        "Imperial small distance should be formatted as feet", feetString.contains("300 feet"));
    ...
    String milesString =
        context
            .getResources()
            .getQuantityString(R.plurals.distance_miles, (int) mile, fmt.format(mile));
    assertTrue(
        "Imperial larger distance should be formatted as miles", milesString.contains("1 mile"));
    ...
    String metersString =
        context
            .getResources()
            .getQuantityString(R.plurals.distance_meters, metersMetric, metersMetric);
    assertTrue(
        "Metric small distance should be formatted as meters", metersString.contains("300 meters"));
    ...
    String kilometersString =
        context
            .getResources()
            .getQuantityString(
                R.plurals.distance_kilometers, (int) kilometer, fmt.format(kilometer));
    assertTrue(
        "Metric larger distance should be formatted as kilometers",
        kilometersString.contains("1 kilometer"));
  }

  /**
   * Runs the simulation with the provided CSV data and expected "Get ready" and "Pull the Cord Now"
   * notification indexes
   *
   * @param csvFileName file name of the CSV file to load from the raw resources directory that
   *     contains the test location data from a user's trip
   * @param expectedGetReadyIndex the index when the "Get Ready" notification is expected
   * @param expectedPullCordIndex the index for when the "Pull the Cord Now" notification is
   *     expected
   */
  private void runSimulation(
      String csvFileName, int expectedGetReadyIndex, int expectedPullCordIndex) throws IOException {
    Reader reader =
        Resources.read(
            InstrumentationRegistry.getInstrumentation().getTargetContext(),
            Resources.getTestUri(csvFileName));
  ...
  class NavigationSimulation {
    ...
    // Index algorithmically identifed as a "good" location for triggering the "Get Ready" alert
    // (vs. a user manually specifying the index that's hard coded into our tests - TODO Actually
    // use this in assertions
    ...
    NavigationSimulation(String csv) {
      ...
      if (useElapsedNanos && Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
        for (int i = 1; i < mLocations.length; i++) {
          mTimes[i] =
              (mLocations[i].getElapsedRealtimeNanos()
                  - mLocations[i - 1].getElapsedRealtimeNanos());
          mTimes[i] /= 1000000;
        }
      } else {
        for (int i = 1; i < mLocations.length; i++) {
    ...
    /**
     * Runs the simulation on the data provided in the constructor using the provided expected
     * values for the index when the "Get Ready" notification is expected and the index for when the
     * "Pull the Cord Now" notification is expected
     *
     * @param expectedGetReadyIndex the index when the "Get Ready" notification is expected
     * @param expectedPullCordIndex the index for when the "Pull the Cord Now" notification is
     *     expected
    ...
    void runSimulation(int expectedGetReadyIndex, int expectedPullCordIndex) {
      NavigationServiceProvider provider =
      ...
      PathLink link =
          new PathLink(
              mLocations[0].getTime(), null, mSecondToLastLocation, mDestinationLocation, mTripId);
  ...
  /**
   * Checks to see if we're running on CI, and if so, skips this test with Assume.assumeTrue(). Note
   * that we can't put this in a @BeforeClass method because otherwise we get "test run failed:
   * 'Test run failed to complete. Expected 204 tests, received 149'"
   */
  public static void checkCI() {
    if (isRunningOnCI()) {
      Assume.assumeTrue(
          "Skipping NavigationTest tests - this is expected behavior when running on CI (#1010,#1072)",
          false);
    }
  }
}
