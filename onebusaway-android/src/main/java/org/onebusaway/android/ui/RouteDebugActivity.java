...
public class RouteDebugActivity extends AppCompatActivity {
    ...
    public static Intent makeIntent(Context context, String routeId) {
        Intent myIntent = new Intent(context, RouteDebugActivity.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (fm.findFragmentById(android.R.id.content) == null) {
            RouteDebugFragment fragment = new RouteDebugFragment();
