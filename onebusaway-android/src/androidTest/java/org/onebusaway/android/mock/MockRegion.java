...
public class MockRegion {
  ...
  public static Region getRegionWithPathNoSeparator(Context context) {
    Region.Bounds bound =
        new Region.Bounds(27.976910500000002, -82.445851, 0.5424609999999994, 0.576357999999999);
  ...
  public static Region getRegionNoSeparator(Context context) {
    Region.Bounds bound = new Region.Bounds(47.221315, -122.4051325, 0.33704, 0.440483);
    Region.Bounds[] bounds = new Region.Bounds[1];
    bounds[0] = bound;
