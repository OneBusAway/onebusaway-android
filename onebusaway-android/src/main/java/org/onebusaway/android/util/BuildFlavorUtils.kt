...
object BuildFlavorUtils {
    ...
    fun isPeliasApiKeyDefined(): Boolean = BuildConfig.PELIAS_API_KEY.isNotEmpty()
    ...
    fun isOBABuildFlavor(): Boolean = BuildConfig.FLAVOR_brand.equals(OBA_FLAVOR_BRAND, ignoreCase = true)
}
