...
public class SurveyUtils {
    ...
    public static Boolean checkValidResponse(StudyResponse studyResponse) {
        return studyResponse != null && studyResponse.getSurveys() != null && !studyResponse.getSurveys().isEmpty();
    }
