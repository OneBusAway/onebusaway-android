...
public class ServiceUtils {
  ...
  /**
   * Given a list of Open311 services (request types), mark which ones are transit-related in place
   * based on group, keyword, or text heuristic matching
   *
   * @param context
   ...
   */
  public static boolean markTransitServices(
      @NonNull Context context, @NonNull List<Service> serviceList) {
    ...
    if (!stopProblemFound) {
      Service s1 =
          new Service(
              context.getString(R.string.ri_service_stop),
    ...
    if (!tripProblemFound) {
      Service s2 =
          new Service(
              context.getString(R.string.ri_service_trip),
   ...
   */
  public static boolean isTransitStopServiceByText(
      @NonNull Context context, @Nullable String text) {
    String[] transitKeywords =
        context.getResources().getStringArray(R.array.report_stop_transit_category_keywords);
   ...
   */
  public static boolean isTransitTripServiceByText(
      @NonNull Context context, @Nullable String text) {
    String[] transitKeywords =
        context.getResources().getStringArray(R.array.report_trip_transit_category_keywords);
  ...
  public static boolean isStopIdField(@NonNull Context context, @Nullable String desc) {
    String[] stopIdKeywords =
        context.getResources().getStringArray(R.array.report_stop_id_field_keywords);
