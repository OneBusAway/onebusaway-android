...
July 28
- Included title to bikeshare directions result on trip planning.

July 27
- Studied about the deep-linking to the bike vendors.

July 26
- Fixed bug that sometimes made the app crash when a bike station marker was tapped.

July 25
- Included missing fields in opentripplanner-pojos class: Place
- Added markers for bike stations that are part of a trip plan in the map view.

July 24
- Fixed name of class LayerUtils and added documentation
- Included bikeshare as an option in trip planning
- Verified staging OTP server created by Sheldon
