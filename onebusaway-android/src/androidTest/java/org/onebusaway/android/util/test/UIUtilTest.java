...
public class UIUtilTest extends ObaTestCase {
  ...
  public void testFormatDisplayText() {
    ...
    // See #883
    assertEquals(
        "Hospital via SPLC Parking", MyTextUtils.formatDisplayText("Hospital via SPLC Parking"));
    assertEquals("SPLC Parking via 70th", MyTextUtils.formatDisplayText("SPLC Parking via 70th"));

    // Route names
    assertEquals(
        "Downtown San Diego - UTC via Old Town",
        MyTextUtils.formatDisplayText("Downtown San Diego - UTC via Old Town"));
    assertEquals("UTC/VA Med CTR Express", MyTextUtils.formatDisplayText("UTC/VA Med CTR Express"));
  }
  ...
  public void testCreateStopDetailsDialogText() {
    ...
    stopDetails =
        StopDetailsDialog.createStopDetailsDialogText(
            targetContext, stopName, stopUserName, stopCode, stopDirection, routeDisplayNames);
    ...
    expectedMessage.append(
        targetContext.getString(DisplayFormat.getStopDirectionText(stopDirection)));
    assertEquals(expectedMessage.toString(), (String) stopDetails.second);
  ...
  public void testArrivalTimeIndexSearch() throws Exception {
    ...
    ArrayList<Integer> preferredArrivalIndexes =
        ArrivalInfoUtils.findPreferredArrivalIndexes(arrivalInfo, favoriteRouteIds);
    ...
    preferredArrivalIndexes =
        ArrivalInfoUtils.findPreferredArrivalIndexes(arrivalInfo, java.util.Collections.emptySet());
  ...
  public void testArrivalInfoLabels() throws Exception {
    ...
    assertEquals("Departing at " + formatTime(1438804500000L), arrivalInfo.get(5).getTimeText());
    ...
    assertEquals("Departing at " + formatTime(1438804800000L), arrivalInfo.get(8).getTimeText());
    ...
    assertEquals("Departing at " + formatTime(1438805700000L), arrivalInfo.get(16).getTimeText());
    assertEquals("4 min delay", arrivalInfo.get(17).getStatusText());
    assertEquals("Arriving at " + formatTime(1438805880000L), arrivalInfo.get(17).getTimeText());
    assertEquals("On time", arrivalInfo.get(18).getStatusText());
    assertEquals("Departing at " + formatTime(1438806000000L), arrivalInfo.get(18).getTimeText());
    assertEquals("8 min delay", arrivalInfo.get(19).getStatusText());
    assertEquals("Arriving at " + formatTime(1438806060000L), arrivalInfo.get(19).getTimeText());
    assertEquals("2 min delay", arrivalInfo.get(20).getStatusText());
    assertEquals("Departing at " + formatTime(1438806124000L), arrivalInfo.get(20).getTimeText());
    assertEquals("3 min delay", arrivalInfo.get(21).getStatusText());
    assertEquals("Arriving at " + formatTime(1438806180000L), arrivalInfo.get(21).getTimeText());
    assertEquals("On time", arrivalInfo.get(22).getStatusText());
    assertEquals("Arriving at " + formatTime(1438806300000L), arrivalInfo.get(22).getTimeText());
    assertEquals("On time", arrivalInfo.get(23).getStatusText());
    assertEquals("Departing at " + formatTime(1438806300000L), arrivalInfo.get(23).getTimeText());
    assertEquals("6 min delay", arrivalInfo.get(24).getStatusText());
    assertEquals("Arriving at " + formatTime(1438806420000L), arrivalInfo.get(24).getTimeText());
    assertEquals("3 min delay", arrivalInfo.get(25).getStatusText());
    assertEquals("Arriving at " + formatTime(1438806420000L), arrivalInfo.get(25).getTimeText());
    assertEquals("6 min delay", arrivalInfo.get(26).getStatusText());
    assertEquals("Arriving at " + formatTime(1438806540000L), arrivalInfo.get(26).getTimeText());
    assertEquals("On time", arrivalInfo.get(27).getStatusText());
    assertEquals("Arriving at " + formatTime(1438806540000L), arrivalInfo.get(27).getTimeText());
    assertEquals("On time", arrivalInfo.get(28).getStatusText());
    assertEquals("Departing at " + formatTime(1438806600000L), arrivalInfo.get(28).getTimeText());
    assertEquals("On time", arrivalInfo.get(29).getStatusText());
    assertEquals("Departing at " + formatTime(1438806600000L), arrivalInfo.get(29).getTimeText());
    assertEquals("9 min delay", arrivalInfo.get(30).getStatusText());
    assertEquals("Arriving at " + formatTime(1438806600000L), arrivalInfo.get(30).getTimeText());
    assertEquals("On time", arrivalInfo.get(31).getStatusText());
    assertEquals("Departing at " + formatTime(1438806600000L), arrivalInfo.get(31).getTimeText());
    ...
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(0).getShortName(), arrivalInfo.get(0).getRouteLongName())
            + " has arrived.",
        arrivalInfo.get(0).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(1).getShortName(), arrivalInfo.get(1).getRouteLongName())
            + " has departed.",
        arrivalInfo.get(1).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(2).getShortName(), arrivalInfo.get(2).getRouteLongName())
            + " has departed.",
        arrivalInfo.get(2).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(3).getShortName(), arrivalInfo.get(3).getRouteLongName())
            + " has arrived.",
        arrivalInfo.get(3).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(4).getShortName(), arrivalInfo.get(4).getRouteLongName())
            + " has departed.",
        arrivalInfo.get(4).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(5).getShortName(), arrivalInfo.get(5).getRouteLongName())
            + " is departing now!",
        arrivalInfo.get(5).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(6).getShortName(), arrivalInfo.get(6).getRouteLongName())
            + " is arriving now!",
        arrivalInfo.get(6).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(7).getShortName(), arrivalInfo.get(7).getRouteLongName())
            + " is arriving in 3 min!",
        arrivalInfo.get(7).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(8).getShortName(), arrivalInfo.get(8).getRouteLongName())
            + " is departing in 5 min!",
        arrivalInfo.get(8).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(9).getShortName(), arrivalInfo.get(9).getRouteLongName())
            + " is departing in 5 min!",
        arrivalInfo.get(9).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(10).getShortName(), arrivalInfo.get(10).getRouteLongName())
            + " is arriving in 6 min!",
        arrivalInfo.get(10).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(11).getShortName(), arrivalInfo.get(11).getRouteLongName())
            + " is arriving in 7 min!",
        arrivalInfo.get(11).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(12).getShortName(), arrivalInfo.get(12).getRouteLongName())
            + " is arriving in 10 min!",
        arrivalInfo.get(12).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(13).getShortName(), arrivalInfo.get(13).getRouteLongName())
            + " is departing in 14 min!",
        arrivalInfo.get(13).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(14).getShortName(), arrivalInfo.get(14).getRouteLongName())
            + " is arriving in 17 min!",
        arrivalInfo.get(14).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(15).getShortName(), arrivalInfo.get(15).getRouteLongName())
            + " is arriving in 20 min!",
        arrivalInfo.get(15).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(16).getShortName(), arrivalInfo.get(16).getRouteLongName())
            + " is departing in 20 min!",
        arrivalInfo.get(16).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(17).getShortName(), arrivalInfo.get(17).getRouteLongName())
            + " is arriving in 23 min!",
        arrivalInfo.get(17).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(18).getShortName(), arrivalInfo.get(18).getRouteLongName())
            + " is departing in 25 min!",
        arrivalInfo.get(18).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(19).getShortName(), arrivalInfo.get(19).getRouteLongName())
            + " is arriving in 26 min!",
        arrivalInfo.get(19).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(20).getShortName(), arrivalInfo.get(20).getRouteLongName())
            + " is departing in 27 min!",
        arrivalInfo.get(20).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(21).getShortName(), arrivalInfo.get(21).getRouteLongName())
            + " is arriving in 28 min!",
        arrivalInfo.get(21).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(22).getShortName(), arrivalInfo.get(22).getRouteLongName())
            + " is arriving in 30 min!",
        arrivalInfo.get(22).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(23).getShortName(), arrivalInfo.get(23).getRouteLongName())
            + " is departing in 30 min!",
        arrivalInfo.get(23).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(24).getShortName(), arrivalInfo.get(24).getRouteLongName())
            + " is arriving in 32 min!",
        arrivalInfo.get(24).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(25).getShortName(), arrivalInfo.get(25).getRouteLongName())
            + " is arriving in 32 min!",
        arrivalInfo.get(25).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(26).getShortName(), arrivalInfo.get(26).getRouteLongName())
            + " is arriving in 34 min!",
        arrivalInfo.get(26).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(27).getShortName(), arrivalInfo.get(27).getRouteLongName())
            + " is arriving in 34 min!",
        arrivalInfo.get(27).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(28).getShortName(), arrivalInfo.get(28).getRouteLongName())
            + " is departing in 35 min!",
        arrivalInfo.get(28).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(29).getShortName(), arrivalInfo.get(29).getRouteLongName())
            + " is departing in 35 min!",
        arrivalInfo.get(29).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(30).getShortName(), arrivalInfo.get(30).getRouteLongName())
            + " is arriving in 35 min!",
        arrivalInfo.get(30).getNotifyText());
    assertEquals(
        "Route "
            + RouteDisplay.getRouteDisplayName(
                arrivalInfo.get(31).getShortName(), arrivalInfo.get(31).getRouteLongName())
            + " is departing in 35 min!",
        arrivalInfo.get(31).getNotifyText());
  }

  /**
   * Validates the ETAs and number of arrivals for Tampa's University Area Transit Center. This data
   * is used for a few tests and we want to make sure it's valid.
   */
  ...
  private String formatTime(long time) {
    return DisplayFormat.formatTime(
        InstrumentationRegistry.getInstrumentation().getTargetContext(), time);
  }
  ...
  public void testGetAllSituations() throws Exception {
    ...
    // They do appear in the references and are referenced by each arrival; getAllSituations gathers
    // them.
