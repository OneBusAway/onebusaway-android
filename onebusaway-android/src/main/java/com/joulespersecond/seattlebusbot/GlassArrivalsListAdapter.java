...
public class GlassArrivalsListAdapter extends ArrayAdapter<ArrivalInfo> {

    private ContentQueryMap mTripsForStop;

    public GlassArrivalsListAdapter(Context context) {
        super(context, R.layout.glass_arrival_card_list_item);
    }
