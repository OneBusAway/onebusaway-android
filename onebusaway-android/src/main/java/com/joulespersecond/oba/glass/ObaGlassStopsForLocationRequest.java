 ...
 */
public final class ObaGlassStopsForLocationRequest extends RequestBase
        implements Callable<ObaStopsForLocationResponse> {

    protected ObaGlassStopsForLocationRequest(Uri uri) {
        super(uri);
    }
    ...
    public static class Builder extends BuilderBase {
        ...
        public ObaGlassStopsForLocationRequest build() {
            return new ObaGlassStopsForLocationRequest(buildUri());
        }
    }
    ...
    public String toString() {
        return "ObaGlassStopsForLocationRequest [mUri=" + mUri + "]";
    }
}
