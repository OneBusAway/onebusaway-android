...
interface MyListConstants {
    ...
    static final int CONTEXT_MENU_SHOW_ON_MAP = 2;
    static final int CONTEXT_MENU_SHOW_URL = 3;

    static final int CONTEXT_MENU_DELETE = 10;
    static final int CONTEXT_MENU_CREATE_SHORTCUT = 15;
}
