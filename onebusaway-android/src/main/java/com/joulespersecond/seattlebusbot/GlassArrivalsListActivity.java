...
public class GlassArrivalsListActivity extends SherlockFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fm.findFragmentById(android.R.id.content) == null) {
            GlassArrivalsListFragment list = new GlassArrivalsListFragment();
    ...
    public GlassArrivalsListFragment getArrivalsListFragment() {
        FragmentManager fm = getSupportFragmentManager();
        return (GlassArrivalsListFragment) fm.findFragmentById(android.R.id.content);
    }
}
