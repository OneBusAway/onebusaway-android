...
public class ObaRegionsService extends IntentService {
    ...
    public ObaRegionsService() {
        super("ObaRegionsService");
    }

    public void onHandleIntent(Intent intent) {
        this.mForceReload = intent.getBooleanExtra("mForceReload", false);
    ...
    public static class ObaRegionsReceiver extends BroadcastReceiver {
        ...
        private static final String TAG = "ObaRegionsReceiver";
        ...
        private ObaRegionsReceiver.Callback mCallback;
        ...
        public void onReceive(Context receiverContext, Intent receiverIntent) {
            ArrayList<ObaRegion> results = (ArrayList<ObaRegion>) receiverIntent
                    .getSerializableExtra("regions");
            if (results == null) {
